            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                    ...
                    <div class="contact-form bg-secondary" style="padding: 30px;">
                        <!-- <div id="success"></div> -->
                        <form  action="contactaddaction.php" method="POST" enctype="multipart/form-data" novalidate="novalidate">
                            ...
                            <div>
                                <button class="btn btn-primary py-3 px-4" name="sub" type="submit" >Send
                                    Message</button>
                            </div>
                        </form>
                    </div>
